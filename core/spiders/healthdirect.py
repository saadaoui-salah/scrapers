        ...
        for param in PARAMS:
            for location in response.json()['data']['suburbs']:
                ...
                yield scrapy.Request(
                    ...
                    f"_next/data/dMOy4AP9PxQTod-WnsbP9/ar/search/{l}/{param[1]}.json?serviceName={param[1]}&offset=0&isMapView=false&params={l}&params={param[1]}",
